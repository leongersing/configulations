...
by default, Configurator is going to recursively dive into a "config" directory located
...
config = Configurator.new #=> finds config/server.json and config/admins.yml
